...
export const MARQUEE_IMAGES = [
  ...
  'https://images.unsplash.com/photo-1551632811-561732d1e58d?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1522163182402-834f871fd851?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=840&h=540&fit=crop',
  ...
  'https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1511593358241-7eea1e3a84e5?w=840&h=540&fit=crop',
  'https://images.unsplash.com/photo-1523580495183-7f8a9f2c4c4e?w=840&h=540&fit=crop',
];
...
export const ACTIVITIES = [
  ...
  },
  {
    icon: '🧘',
    title: 'Yoga',
    items: ['Meditation', 'Flexibility', 'Mindfulness'],
    image: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=800&h=600&fit=crop',
  },
  {
    icon: '💃',
    title: 'Zumba',
    items: ['Dance Fitness', 'Weekend Sessions', 'High Energy'],
    image: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&h=600&fit=crop',
  },
  {
    icon: '🥾',
    title: 'Trekking',
    items: ['Weekend Treks', 'Camping', 'Nature Exploration'],
    image: 'https://images.unsplash.com/photo-1551632811-561732d1e58d?w=800&h=600&fit=crop',
  },
  {
    icon: '🚴',
    title: 'Cycling',
    items: ['Road Cycling', 'Adventure Rides', 'Community Cycling'],
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop',
  },
  {
    icon: '🌿',
    title: 'Wellness',
    items: ['Nutrition', 'Fitness Challenges', 'Outdoor Workshops'],
...
export const JOURNEY_MILESTONES = [
  { year: '2026', title: 'The Motion Club Founded' },
  { year: '2026', title: 'First Running Community' },
  { year: '2026', title: 'Yoga Sessions Started' },
  { year: '2026', title: 'Weekend Treks' },
  { year: '2026', title: 'Community Events' },
  { year: '2026', title: '1000+ Members' },
  { year: '2027', title: 'Expand Across India' },
];
...
export const STATS = [
  ...
  { value: 50, suffix: '+', label: 'Treks' },
  { value: 1000, suffix: '+', label: 'Lives Inspired' },
];
